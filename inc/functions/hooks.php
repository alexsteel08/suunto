...
add_action('woocommerce_shop_loop_item_title', 'woocommerce_after_shop_loop_item_title_description', 10);
function woocommerce_after_shop_loop_item_title_description()
{ ?>
...
add_action('woocommerce_before_shop_loop', 'woocommerce_before_shop_loop_baner', 10);
