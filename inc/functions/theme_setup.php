...
function custom_post_type()
{
    ...
    $support = array(
        'name' => _x('Support', 'Post Type General Name', 'text_domain'),
        'singular_name' => _x('Support', 'Post Type Singular Name', 'text_domain'),
        'menu_name' => __('Support', 'text_domain'),
        'name_admin_bar' => __('Support', 'text_domain'),
        'archives' => __('Item Archives', 'text_domain'),
        'attributes' => __('Item Support', 'text_domain'),
        'parent_item_colon' => __('Parent Item:', 'text_domain'),
        'all_items' => __('All Instructions', 'text_domain'),
        'add_new_item' => __('Add item', 'text_domain'),
        'add_new' => __('Add item', 'text_domain'),
    ...
    $actions = array(
        'name' => _x('Action', 'Post Type General Name', 'text_domain'),
        'singular_name' => _x('Action', 'Post Type Singular Name', 'text_domain'),
        'menu_name' => __('Action', 'text_domain'),
        'name_admin_bar' => __('Action', 'text_domain'),
        'archives' => __('Item Archives', 'text_domain'),
        'attributes' => __('Item Action', 'text_domain'),
        'parent_item_colon' => __('Parent Item:', 'text_domain'),
        'all_items' => __('All Instructions', 'text_domain'),
        'add_new_item' => __('Add item', 'text_domain'),
        'add_new' => __('Add item', 'text_domain'),
